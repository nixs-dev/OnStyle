    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-footer bg-primary bg-gradient">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal" onclick="addToCart('<?php echo e(csrf_token()); ?>')">Confirmar</button>
            </div>
        </div>
    </div>
</div><?php /**PATH C:\Users\joabe\Desktop\AlinesStore\resources\views/components/amountToCart.blade.php ENDPATH**/ ?>